...
DELETE FROM creature WHERE id IN (36838, 36839, 36948, 36939);
...
DELETE FROM `spell_linked_spell` WHERE `spell_trigger` = 73077 AND `spell_effect` = 68645;
...
(@MURADIN_INVISIBLE,  0, 0, '¡Mueve ese trasto o lo reventamos orco. La Horda no pinta nada aquí!', 14, 0, 0, 0, 0, 16969, 'Muradin Bronzebeard - INVISIBLE_0'),
(@MURADIN_INVISIBLE,  1, 0, '¡Soldados, sargentos, atacad!', 14, 0, 0, 0, 0, 16956, 'Muradin Bronzebeard - INVISIBLE_1'),
(@MURADIN,  0, 0, '¡Arrancad motores. Tenemos una cita con el destino, muchachos!', 14, 0, 100, 0, 0, 16962, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_0'),
(@MURADIN,  1, 0, '¡Agarráos fuerte!', 14, 0, 100, 0, 0, 16963, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_1'),
(@MURADIN,  2, 0, '¿Qué demonios es esto? ¡Tripulante, mi catalejo!', 14, 0, 100, 0, 0, 16964, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_2'),
(@MURADIN,  3, 0, '¡Por mis barbas! ¡LA HORDA NAVEGA A TODA MÁQUINA!', 14, 0, 100, 0, 0, 16965, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_3'),
(@MURADIN,  4, 0, '¡ACCIÓN EVASIVA, A LAS ARMAS!', 14, 0, 100, 0, 0, 16966, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_4'),
(@MURADIN,  5, 0, '¡Cobardes! ¡Nos pilláis por sorpresa!', 14, 0, 100, 0, 0, 16967, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_5'),
(@MURADIN,  6, 0, '¿Que no es mi batalla? No sé quién te crees que eres amigo. Pero tengo un asunto pendiente con Arthas, ¡y no te vas a poner en mi camino! ¡DISPARAD, FUEGO, FUEGO!', 14, 0, 100, 0, 0, 16968, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_7'),
(@MURADIN,  7, 0, '¡Mueve ese trasto o lo reventamos orco. La Horda no pinta nada aquí!', 14, 0, 100, 0, 0, 16969, 'Muradin Bronzebeard - SAY_INTRO_HORDE_3'),
(@MURADIN,  8, 0, '¡¿Qué es esto?! ¡No derribaréis la nave de este hijo de Forjaz sin luchar!.', 14, 0, 100, 0, 0, 16958, 'Muradin Bronzebeard - SAY_BOARDING_SKYBREAKER_1'),
(@MURADIN,  9, 0, '¡Soldados, sargentos, atacad!', 14, 0, 100, 0, 0, 16956, 'Muradin Bronzebeard - SAY_BOARDING_ORGRIMS_HAMMER_0'),
(@MURADIN, 10, 0, '¡Fusileros, más rápido!', 14, 0, 100, 0, 0, 16954, 'Muradin Bronzebeard - SAY_NEW_RIFLEMEN_SPAWNED'),
(@MURADIN, 11, 0, '¡Morteros, cargad!', 14, 0, 100, 0, 0, 16955, 'Muradin Bronzebeard - SAY_NEW_MORTAR_TEAM_SPAWNED'),
(@MURADIN, 12, 0, '¡Nos están dañando el casco! ¡Traed un brujo aquí para acabar con esos cañones!', 14, 0, 100, 0, 0, 16957, 'Muradin Bronzebeard - SAY_NEW_MAGE_SPAWNED'),
...
(@MURADIN, 14, 0, '¡Capitán Bartlett vámonos! ¡Hemos sufrido muchos daños, como para seguir volando!', 14, 0, 100, 0, 0, 16960, 'Muradin Bronzebeard - SAY_ALLIANCE_DEFEAT'),
(@OVERLORD_INVISIBLE, 0, 0, 'Esta no es tu batalla, enano. Atrás o tendremos que destruir vuestro barco.', 14, 0, 0, 0, 0, 17093, 'High Overlord Saurfang - INVISIBLE_0'),
(@OVERLORD_INVISIBLE, 1, 0, '¡Atracadores, sargentos, atacad!', 14, 0, 0, 0, 0, 17081, 'High Overlord Saurfang - INVISIBLE_1'),
(@OVERLORD, 0, 0, '¡Alzaos, hijos de la Horda! Hoy nos enfrentamos a un odiado enemigo. ¡LOK´TAR OGAR!', 14, 0, 100, 0, 0, 17087, 'High Overlord Saurfang - SAY_INTRO_HORDE_0'),
(@OVERLORD, 1, 0, '¡Kor´kron sácanos de aquí!', 14, 0, 100, 0, 0, 17088, 'High Overlord Saurfang - SAY_INTRO_HORDE_1_1'),
(@OVERLORD, 2, 0, '¿Qué es eso? ¡Algo se aproxima en la distancia!', 14, 0, 100, 0, 0, 17089, 'High Overlord Saurfang - SAY_INTRO_HORDE_1'),
(@OVERLORD, 3, 0, '¡LA NAVE DE GUERRA DE LA ALIANZA, TODOS A LA CUBIERTA!', 14, 0, 100, 0, 0, 17090, 'High Overlord Saurfang - SAY_INTRO_HORDE_2'),
(@OVERLORD, 4, 0, '¡Pronto sabrás qué pintamos aquí! ¡KOR´KRON ANIQUILADLOS!', 14, 0, 100, 0, 0, 17092, 'High Overlord Saurfang - SAY_INTRO_HORDE_4'),
(@OVERLORD, 5, 0, '¡Atracadores, sargentos, atacad!', 14, 0, 100, 0, 0, 17081, 'High Overlord Saurfang - SAY_BOARDING_SKYBREAKER_0'),
(@OVERLORD, 6, 0, '¿Te atreves a abordar mi barco? ¡Tendrás una muerte rápida!', 14, 0, 100, 0, 0, 17083, 'High Overlord Saurfang - SAY_BOARDING_ORGRIMS_HAMMER_1'),
(@OVERLORD, 7, 0, '¡Lanzahachas más rápido!', 14, 0, 100, 0, 0, 17079, 'High Overlord Saurfang - SAY_NEW_AXETHROWER_SPAWNED'),
(@OVERLORD, 8, 0, '¡Artificieros cargad!', 14, 0, 100, 0, 0, 17080, 'High Overlord Saurfang - SAY_NEW_ROCKETEERS_SPAWNED'),
(@OVERLORD, 9, 0, '¡Nos están dañando el casco! ¡Traed un mago de batalla aquí para acabar con esos cañones!', 14, 0, 100, 0, 0, 17082, 'High Overlord Saurfang - SAY_NEW_BATTLE_MAGE_SPAWNED'),
(@OVERLORD, 10, 0, 'La Alianza retrocede. ¡Hacia el Rey Exánime!', 14, 0, 100, 0, 0, 17084, 'High Overlord Saurfang - SAY_HORDE_VICTORY'),
(@OVERLORD, 11, 0, '¡Control de daños, apagad esos fuegos. No será nuestro último encuentro!', 14, 0, 100, 0, 0, 17085, 'High Overlord Saurfang - SAY_HORDE_DEFEAT'),
(@OVERLORD, 12, 0, 'Esta no es su batalla, enano. Marcha atrás o nos veremos obligados a destruir tu nave.', 14, 0, 100, 0, 0, 17093, 'High Overlord Saurfang - SAY_INTRO_ALLIANCE_6'),
