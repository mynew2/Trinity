                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_BOARDING_GUNSHIP:
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_PORTAL, 60000);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_RENDING_THROW:
                            ...
                            break;
                        case EVENT_RESPAWN_ROCKETEER:
							if(me->GetEntry() != NPC_GB_KORKRON_ROCKETEER)
							{
    ...
    public:
        ...
        struct npc_icc_spire_frostwyrmAI : public ScriptedAI
        {
            ...
            void MoveInLineOfSight(Unit* who)
            {
                ...
                if (!landed && me->IsWithinDistInMap(who, 20.0f))
                {
                    if (instance->GetData(DATA_TEAM_IN_INSTANCE) == HORDE)
...
class spell_icc_remove_rocket_pack : public SpellScriptLoader
{
    public:
        ...
        class spell_icc_remove_rocket_pack_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_icc_remove_rocket_pack_SpellScript::HandleEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);  //note
            }
        };
...
class spell_gb_burning_pitch : public SpellScriptLoader
{
    public:
        ...
        class spell_gb_burning_pitch_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gb_burning_pitch_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY); //note
            }
		};
